package id.rdev.DaftarBelanja.network

import id.rdev.DaftarBelanja.activity.data_barang.data.ResultDataBarang
import id.rdev.DaftarBelanja.activity.login.data.ResultLogin
import id.rdev.DaftarBelanja.activity.penjualan.data.ResultKeranjang
import id.rdev.DaftarBelanja.activity.penjualan.data.ResultSearchBarang
