package id.rdev.DaftarBelanja.activity._main
...
import id.rdev.DaftarBelanja.R
import id.rdev.DaftarBelanja.activity._main.adapter.MenuAdapter
import id.rdev.DaftarBelanja.activity._main.presenter.MainPresenter
import id.rdev.DaftarBelanja.activity._main.presenter.MainView
import id.rdev.DaftarBelanja.activity.data_barang.DataBarangActivity
import id.rdev.DaftarBelanja.activity.login.LoginActivity
import id.rdev.DaftarBelanja.activity.penjualan.PenjualanBarang
import id.rdev.DaftarBelanja.activity.report.ReportActivity
import id.rdev.DaftarBelanja.base.BaseActivity
import id.rdev.DaftarBelanja.model.Keranjang
import id.rdev.DaftarBelanja.utils.Uang
